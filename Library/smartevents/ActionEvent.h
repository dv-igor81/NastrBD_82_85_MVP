...
namespace smartevents
{
	...
	{
	public:
		ActionEvent(ActionDebugSettings * l_Debug = 0, char * l_methodName = 0) // Конструктор
			: ActionEventBase(l_Debug, MAX_SIZE_FOR_ACTION_TEXT_LENGTH, l_methodName, "(T1 ... T10)"){}
		~ActionEvent(){}
	...
	public:
		ActionEvent(ActionDebugSettings * l_Debug = 0, char * l_methodName = 0) // Конструктор
			: ActionEventBase(l_Debug, MAX_SIZE_FOR_ACTION_TEXT_LENGTH, l_methodName, "(T1 ... T9)"){}
		~ActionEvent(){}
	...
	public:
		ActionEvent(ActionDebugSettings * l_Debug = 0, char * l_methodName = 0) // Конструктор
			: ActionEventBase(l_Debug, MAX_SIZE_FOR_ACTION_TEXT_LENGTH, l_methodName, "(T1 ... T8)"){}
		~ActionEvent(){}
	...
	public:
		ActionEvent(ActionDebugSettings * l_Debug = 0, char * l_methodName = 0) // Конструктор
			: ActionEventBase(l_Debug, MAX_SIZE_FOR_ACTION_TEXT_LENGTH, l_methodName, "(T1 ... T7)"){}
		~ActionEvent(){}
	...
	public:
		ActionEvent(ActionDebugSettings * l_Debug = 0, char * l_methodName = 0) // Конструктор
			: ActionEventBase(l_Debug, MAX_SIZE_FOR_ACTION_TEXT_LENGTH, l_methodName, "(T1 ... T6)"){}
		~ActionEvent(){}
	...
	public:
		ActionEvent(ActionDebugSettings * l_Debug = 0, char * l_methodName = 0) // Конструктор
			: ActionEventBase(l_Debug, MAX_SIZE_FOR_ACTION_TEXT_LENGTH, l_methodName, "(T1 ... T5)"){}
		~ActionEvent(){}
	...
	public:
		ActionEvent(ActionDebugSettings * l_Debug = 0, char * l_methodName = 0) // Конструктор
			: ActionEventBase(l_Debug, MAX_SIZE_FOR_ACTION_TEXT_LENGTH, l_methodName, "(T1 ... T4)"){}
	...
	public:
		ActionEvent(ActionDebugSettings * l_Debug = 0, char * l_methodName = 0) // Конструктор
			: ActionEventBase(l_Debug, MAX_SIZE_FOR_ACTION_TEXT_LENGTH, l_methodName, "(T1 ... T3)"){}
		~ActionEvent() // Деструктор
		{}
	...
	public:
		ActionEvent(ActionDebugSettings * l_Debug = 0, char * l_methodName = 0) // Конструктор
			: ActionEventBase(l_Debug, MAX_SIZE_FOR_ACTION_TEXT_LENGTH, l_methodName, "(T1, T2)"){}
		~ActionEvent() // Деструктор
		{}
	...
	public:
		ActionEvent(ActionDebugSettings * l_Debug = 0, char * l_methodName = 0) // Конструктор
			: ActionEventBase(l_Debug, MAX_SIZE_FOR_ACTION_TEXT_LENGTH, l_methodName, "(T1)"){}
		~ActionEvent() // Деструктор
		{}
	...
	public:
		ActionEvent(ActionDebugSettings * l_Debug = 0, char * l_methodName = 0) // Конструктор
			: ActionEventBase(l_Debug, MAX_SIZE_FOR_ACTION_TEXT_LENGTH, l_methodName, "(void)"){}
		~ActionEvent() // Деструктор
		{}
		void operator()(void)
		{
