...
float RSProtokol_t::TConvert(int Temper)
{
  ...
  if (Data.Ver_HEX != 0)
  {
    ...
    else
    {
      ...
      // Коэффициенты от Халькиной Елены Сергеевны
      //   ADUC834 с подгоном к окружающей температуре
      //==\\g_fltTSlope = -0.0011058 / 0.0014; // -0.827
      //==\\g_fltTOffset = 0.744 / 0.0014; // 531.43
