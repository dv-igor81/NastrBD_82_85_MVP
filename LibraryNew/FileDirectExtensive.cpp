...
//---------------------------------------------------------------------------
void FileDirectExtensive::ReadString (
    char *& retVal, // [OUT]
    ...
    bool * flagError )
{
    ...
    {
        ReadStringHelper( retVal, def ); // retVal := def
        return;
    }
    ...
    {
        ReadStringHelper( retVal, value.c_str() ); // retVal := def
    }
}
//---------------------------------------------------------------------------
void FileDirectExtensive::WriteString (
    char * value, // [IN]
    const char * paramName) // [IN]
{
...
//---------------------------------------------------------------------------
void FileDirectExtensive::ReadStringHelper( // retVal := chText
    char *& retVal, // [OUT]
    const char * chText ) // [IN]
{
    sprintf(_chString, "%s", chText);
    retVal = _chString;
}
//---------------------------------------------------------------------------
