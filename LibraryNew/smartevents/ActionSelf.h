...
namespace smarteventsMin
{
	...
	public:
		...
		ActionSelf(TC * i_class, M i_method) : ActionSelfBase(new ContainerAS<TC, M, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(i_class, i_method)){}
		~ActionSelf(){}
	...
	public:
		template<class TC, class M>
		ActionSelf(TC * i_class, M i_method) : ActionSelfBase(new ContainerAS<TC, M, T1, T2, T3, T4, T5, T6, T7, T8, T9>(i_class, i_method)){}
		~ActionSelf(){}
	...
	public:
		template<class TC, class M>
		ActionSelf(TC * i_class, M i_method) : ActionSelfBase(new ContainerAS<TC, M, T1, T2, T3, T4, T5, T6, T7, T8>(i_class, i_method)){}
		~ActionSelf(){}
	...
	public:
		template<class TC, class M>
		ActionSelf(TC * i_class, M i_method) : ActionSelfBase(new ContainerAS<TC, M, T1, T2, T3, T4, T5, T6, T7>(i_class, i_method)){}
		~ActionSelf(){}
	...
	public:
		template<class TC, class M>
		ActionSelf(TC * i_class, M i_method) : ActionSelfBase(new ContainerAS<TC, M, T1, T2, T3, T4, T5, T6>(i_class, i_method)){}
		~ActionSelf(){}
	...
	public:
		template<class TC, class M>
		ActionSelf(TC * i_class, M i_method) : ActionSelfBase(new ContainerAS<TC, M, T1, T2, T3, T4, T5>(i_class, i_method)){}
		~ActionSelf(){}
	...
	public:
		template<class TC, class M>
		ActionSelf(TC * i_class, M i_method) : ActionSelfBase(new ContainerAS<TC, M, T1, T2, T3, T4>(i_class, i_method)){}
		~ActionSelf(){}
	...
	public:
		template<class TC, class M>
		ActionSelf(TC * i_class, M i_method) : ActionSelfBase(new ContainerAS<TC, M, T1, T2, T3>(i_class, i_method)){}
		~ActionSelf(){}
	...
	public:
		template<class TC, class M>
		ActionSelf(TC * i_class, M i_method) : ActionSelfBase(new ContainerAS<TC, M, T1, T2>(i_class, i_method)){}
		~ActionSelf(){}
	...
	public:
		template<class TC, class M>
		ActionSelf(TC * i_class, M i_method) : ActionSelfBase(new ContainerAS<TC, M, T1>(i_class, i_method)){}
		~ActionSelf(){}
	...
	public:
		template<class TC, class M>
		ActionSelf(TC * i_class, M i_method) : ActionSelfBase(new ContainerAS<TC, M>(i_class, i_method)){}
		~ActionSelf(){}
		void operator()()
		{
			Call(0);
